<template>
    <div class="flex items-center" >
        ...
        <div v-if="ip&&ip.length" class="text-xs md:text-base bg-white border rounded-md px-2 leading-[38px] ml-2 cursor-pointer hover:bg-[#EEE]" :title="$t('device.to-copy')" @click="copyTo()">
